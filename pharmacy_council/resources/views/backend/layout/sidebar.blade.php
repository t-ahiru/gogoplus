        <ul id="side-main-menu" class="side-menu list-unstyled d-print-none">
            ...
            ?>
            @if($category_permission_active || $index_permission_active || $print_barcode_active || $stock_count_active || $adjustment_active || product_expiry_report_active || $product_qty_alert_active)
            ...
            <ul id="product" class="collapse list-unstyled ">
                ...
                @endif
				@if($product_qty_alert_active)
				<li id="shelf-list-menu">
					<a href="{{ route('shelves.index') }}">Shelf List</a>
				</li>
				<li id="add-shelf-menu">
					<a href="{{ route('shelves.create') }}">Add Shelf</a>
				</li>
				@endif
            </ul>
            </li>
            ...
            <ul id="sale" class="collapse list-unstyled ">
                ...
                <li id="sale-create-menu"><a href="{{route('sales.create')}}">Add Sale</a></li>
				<li id="refill-create-menu"><a href="{{route('refill.index')}}">Refill List</a></li>
				<li id="refill-create-menu"><a href="{{route('refill.create')}}">Add Refill</a></li>
            ...
            ?>
            @if($profit_loss_active || $best_seller_active || $warehouse_report_active || $warehouse_stock_report_active || $product_report_active || $daily_sale_active || $monthly_sale_active || $daily_purchase_active || $monthly_purchase_active || $purchase_report_active || $sale_report_active || $sale_report_chart_active || $payment_report_active || $dso_report_active || $user_report_active || $biller_report_active || $customer_report_active || $supplier_report_active || $due_report_active || $supplier_due_report_active)
            ...
            <ul id="report" class="collapse list-unstyled ">
                ...
                @endif
				<li id="yearly-profit-report-menu">
					<a href="{{ route('report.yearly_profit') }}">Profit Report</a>
				</li>
            ...
            <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-gear"></i><span>{{trans('file.settings')}}</span></a>
                <ul id="setting" class="collapse list-unstyled ">
					...
					<li id="role-menu"><a href="{{route('sms.index')}}">SMS List</a></li>
                    ...
                    @endif
					<li id="insurance-menu"><a href="{{route('insurance.index')}}">Insurance</a></li>
