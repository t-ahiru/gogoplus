                ...
                {!! Form::open(['route' => 'sale.add-payment', 'method' => 'post', 'files' => true, 'class' => 'payment-form' ]) !!}
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="amount" name="amount" class="form-control" readonly  step="any" required>
                        </div>
                        ...
                        <div class="col-md-6 mt-1">
                            ...
                            <select name="paid_by_id" class="form-control">
								...
								@endif
								@if(in_array("insurance",$options))
								<option value="9">Mobile Money</option>
								@endif
								@if(in_array("insurance",$options))
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" value="{{$user_name}}" name="payment_receiver" readonly class="form-control">
                        </div>
                    </div>
            ...
            <div class="modal-body">
                {!! Form::open(['route' => 'sale.update-payment', 'method' => 'post', 'class' => 'payment-form' ]) !!}
                    <div class="row">
                        <div class="col-md-6">
                            <label>{{trans('file.Recieved Amount')}} *</label>
                            <input type="text" name="edit_paying_amount" class="form-control numkey"  step="any" required readonly>
                        </div>
                        <div class="col-md-6">
                            <label>{{trans('file.Paying Amount')}} *</label>
                            <input type="text" name="edit_amount" class="form-control"  step="any" required readonly>
                        </div>
                        <div class="col-md-6 mt-1">
                            <label>{{trans('file.Change')}} : </label>
                            <p class="change ml-2">{{number_format(0, $general_setting->decimal, '.', '')}}</p>
						...
						<div class="col-md-6 mt-1" >
                            ...
                            <select name="edit_payment_status" class="form-control selectpicker">
                                <option value="1">{{trans('file.Pending')}}</option>
                                <option value="2">{{trans('file.Due')}}</option>
                                <option value="3">{{trans('file.Partial')}}</option>
                                <option value="4">{{trans('file.Paid')}}</option>
                        ...
                        <div class="col-md-6">
                            <label>{{trans('file.Payment Receiver')}}</label>
                            <input type="text" name="payment_receiver" class="form-control" readonly>
                        </div>
                    </div>
                    <div class="gift-card form-group">
                        <label> {{trans('file.Gift Card')}} *</label>
...
<div id="send-sms" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('sms.sale') }}" method="post">
                    @csrf
                    <div class="row">
